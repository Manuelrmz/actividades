...
<div class="col-sm-12 div-border">
	...
	<form id="formRecibos" method="post" enctype="multipart/form-data">
		...
		<div class="col-sm-12 margin-form" id="divFile" style="display:none;">
			<div class="col-sm-12"><b>Agregar Resguardo Firmado:&nbsp;</b><input type="file" id="file" name="reciboPdf" accept="application/pdf"></div>
		</div>
		<div class="col-sm-12 text-center margin-form">
			...
			<div style="margin-left:30px; display:none;" class="k-button" id="btnPdfSigned">Ver Recibo Firmado</div>
		</div>
	</form>
</div>
<div class="col-sm-12 div-border">
