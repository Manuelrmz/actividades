...
<div class="col-sm-12 div-border">
	...
	<form action="">
		...
		<div class="col-sm-4">
			<div class="col-sm-12 bold margin-form">Personal</div>
		...
		<div class="col-sm-12 margin-form">
			...
			<div class="col-xs-10 margin-form"><select id="equipos" style="width: 100%;"></select></div>
			<div class="col-xs-2"><div class="k-button" id="btnAddEquip">Agregar</div></div>
			<div class="col-xs-12">
