...
function complete()
{
    ...
    $("#gridEquipos").kendoGrid(
    {
        ...
        navigatable:true,
        columns: [
            { field: "cantidad",title:'Cant.',width:60},
            { field: "codigo",title:'Codigo',width:60},
            { field: "categoria",title:'Categoria',editor:categoriaAutoCompleteEditor,width:200},
            { field: "tipoEquipo",title:'Tipo de Equipo', editor:tipoEquipoAutoCompleteEditor,width:200},
            { field: "marca",title:'Marca', editor:marcaAutoCompleteEditor,width:200},
            ...
            { field: "costo", title:"Costo",width:100},
