<?php
	echo $this->addScript('view/sitios/css/index.css','css');
  ...
  echo $this->addScript('core/css/alertbox.css','css');
	echo $this->addScript('view/sitios/js/index.js','js');
?>
<div class="div-border col-xs-12">
  <div class="col-sm-12 text-center margin-form"><h3>Sitios</h3></div>
  <div class="col-sm-12 margin-form bold" id="titleForm">Nuevo Sitio</div>
  <form enctype="multipart/form-data" id="formSitio" method="post">
    <div class="col-sm-5">
      ...
      <div class="col-xs-3 margin-form bold" style="height:21px; line-height: 2;">Imagenes</div>
      <div class="col-xs-9 margin-form"><input type="file" name="imgSitio[]" multiple = multiple id="imgSitio" accept="image/*"></div>
    </div>
    <div class="col-sm-7">
    ...
    <div class="col-sm-12 margin-form text-center" style="margin-top:10px;">
      ...
      <div class="k-button" id="btnCleanFields" style="margin-left:15px;">Limpiar Campos</div>
    </div>
  </form>
</div>
<div class="div-border col-xs-12">
